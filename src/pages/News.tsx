...
Take your time with this decision. Visit projects. Check references. Trust your instincts. And once you've found the right architect, commit fully to the collaborative process. The best projects emerge when clients and architects work together with mutual respect, clear communication, and shared commitment to excellence.`,
  ...
  const categories = ["All", "Design Trends", "Awards", "Sustainability", "Client Guide"];
      ...
      <section className="pt-24 pb-16 bg-gradient-to-b from-muted/30 to-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold mb-6 text-foreground">News & Insights</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Stay updated with the latest in coastal architecture, design trends, project updates, 
              and insights from our award-winning practice.
            </p>
          </div>
        </div>
      </section>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <CardContent className="p-8 flex flex-col justify-center">
                  ...
                  <h2 className="text-3xl font-bold mb-4 text-foreground">{featuredPost.title}</h2>
